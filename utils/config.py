...
from utils.metrics import ClassificationMetric,MaskModelMetric
...
class DATASET_TYPE:
    ...
    @staticmethod
    def get_mlm_evaluation_metric(dataset: str, compare_key: str = '-loss'):
        return MaskModelMetric(compare_key)
