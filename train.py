...
class Classifier:
    ...
    def evaluate(self, args: ClassifierArgs, is_training=False) -> Metric:
        if is_training:
            ...
            self.loading_model_from_file(args.saving_dir, args.build_saving_file_name(description='best'))
            #/data/ZhanghData/Pretrained_Models/nli-MiniLM2-L6-H768/pytorch_model.bin
...
if __name__ == '__main__':
    # CUDA_VISIBLE_DEVICES=3 python test_classifier.py --model_type bert --dataset_name snli
    # CUDA_VISIBLE_DEVICES=3 python3 train.py --model_type roberta --dataset_name snli
    ...
    args.max_seq_length = 256 if args.dataset_name == ['imdb','snli'] else 128
